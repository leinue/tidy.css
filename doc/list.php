...
<div class="content">
	...
	<p>列表是各元素的集合</p>
	<h3 class="marketing-header">使用列表</h3>
	<p>要使用列表,仅需一个.list-group类即可.注意,在Tidy中列表不用ul-li,而是用div-a.如下是一个基本的列表</p>
	<div class="tidy-g">
...
&lt;/div&gt;</code></pre>
	...
	<p>在这里需要说明一下,list-group里的元素其实都是btn类,Tidy对它们做了定制,这个您也可以完成:)</p>
</div>
